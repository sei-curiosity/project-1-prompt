...
- Some unique features that distinguish your game from the "normal" solution are listed above. Here are some ideas:
...
FOR EXAMPLE YOU'RE WORKING ON 'TIC TAC TOE' - GAME
...
9.  Begin working on the [user stories](https://github.com/sei-curiosity/project-1-prompt/edit/master/README.md), 1 at a time
